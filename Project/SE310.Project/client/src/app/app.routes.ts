...
import { ProductEditComponent } from './features/shop/product-edit/product-edit.component';
...
export const routes: Routes = [
  ...
  // { path: 'shop/:id/edit', component: ProductEditComponent, canActivate: [authGuard, adminGuard] },
