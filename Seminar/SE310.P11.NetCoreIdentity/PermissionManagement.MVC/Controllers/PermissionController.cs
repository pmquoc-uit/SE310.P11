...
namespace PermissionManagement.MVC.Controllers
{
    ...
    public class PermissionController : Controller
    {
        ...
        public async Task<ActionResult> Index(string roleId)
        {
            ...
            //Console.WriteLine(allPermissions[0].Value.ToString());
            model.RoleId = roleId;
            var claims = await _roleManager.GetClaimsAsync(role);
            //Console.WriteLine(claims[0].GetType().ToString());
            ...
            //Console.WriteLine(model.RoleClaims[0].Selected.ToString());
            return View(model);
        }
        ...
        public async Task<IActionResult> Update(PermissionViewModel model)
        {
            ...
            //return RedirectToAction("Index", routeValues: new { roleId = model.RoleId });
            return RedirectToAction("Index", "Home", new { roleId = model.RoleId });
